...
# -*- coding: utf-8 -*-
"""
PDF Home模块 - 启动pdf-home应用
负责启动和管理pdf-home的PyQt界面
"""
...
class PDFHomeModule(BaseService):
    """
    PDF Home模块 - 负责启动pdf-home应用
    """
    ...
    def __init__(self, project_root: Path):
        ...
        Args:
            project_root: 项目根目录
        """
        super().__init__("pdf-home", project_root)
    ...
    def get_command(self, **kwargs) -> List[str]:
        ...
        # 构建基础命令
        command = [python_executable, str(app_script), "--module", "pdf-home"]
    ...
    def get_status_info(self) -> Dict[str, any]:
        ...
        # 添加pdf-home特定状态
        status["module_type"] = "pdf-home"
        status["description"] = "PDF Home管理界面"
