...
- v006：已合入 main（2026-01-11），对齐 new-card-scheduler 启动范式为 `index.js -> bootstrap runner -> feature/container`（参考 pdf-home/pdf-viewer）；任务已归档：`todo-and-doing/4 archive/20260111015251-doing-archive/`。
