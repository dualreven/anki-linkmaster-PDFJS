...
export const WEBSOCKET_MESSAGE_EVENTS = { PDF_LIST_UPDATED: "websocket:message:updated", PDF_LIST: "websocket:message:list", PDF_LIST_RECEIVED: "websocket:message:received", LOAD_PDF_FILE: "websocket:message:load_pdf_file", SUCCESS: "websocket:message:success", ERROR: "websocket:message:error", RESPONSE: "websocket:message:response", UNKNOWN: "websocket:message:unknown" };
