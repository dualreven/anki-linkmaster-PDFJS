...
export const WEBSOCKET_MESSAGE_TYPES = { GET_PDF_LIST: "get_pdf_list", ADD_PDF: "add_pdf", REMOVE_PDF: "remove_pdf", BATCH_REMOVE_PDF: "batch_remove_pdf", OPEN_PDF: "open_pdf", REQUEST_FILE_SELECTION: "request_file_selection", PDF_DETAIL_REQUEST: "pdf_detail_request", PDF_VIEW_REQUEST: "pdf_view_request" };
