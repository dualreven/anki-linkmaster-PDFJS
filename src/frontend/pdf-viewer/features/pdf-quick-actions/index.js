...
export class TextSelectionQuickActionsFeature {
  ...
  get dependencies() {
    return ["infra-app", "pdf-annotation", "pdf-translator"];
  }
  ...
  async install(context) {
    ...
    this.#unsubscribes.push(
      this.#eventBus.on(PDF_VIEWER_EVENTS.ANNOTATION.TOOL.ACTIVATED, () => {
    ...
    this.#unsubscribes.push(
      this.#eventBus.on(PDF_VIEWER_EVENTS.ANNOTATION.TOOL.DEACTIVATED, () => {
