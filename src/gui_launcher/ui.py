...
def build_param_panels(parent: Any) -> Dict[str, Any]:
    ...
    viewer_pdf_id = QLineEdit(); viewer_pdf_id.setPlaceholderText("doc-id（可选）")
    ...
    viewer_anchor = QLineEdit(); viewer_anchor.setPlaceholderText("anchor_id（可选）")
    viewer_annot = QLineEdit(); viewer_annot.setPlaceholderText("annotation_id（可选）")
    viewer_outline = QLineEdit(); viewer_outline.setPlaceholderText("outline_item_id（可选）")
