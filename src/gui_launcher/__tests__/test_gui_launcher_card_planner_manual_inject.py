...
def test_card_planner_inject_ack_meta_parse_compat_data_shape(monkeypatch):
    _install_pyqt_stubs()
    mod = _load_gui_launcher_as("gui_launcher_mod_test_card_planner_inject_ack_meta_data_shape")
